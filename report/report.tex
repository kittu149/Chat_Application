...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{Phase 5: Alice log showing 3 rotations.}
...
\begin{enumerate}[label={[\arabic*]}]
    \item \textbf{Source Code Repository:} CS6008 Secure Chat Application, GitHub: \url{https://github.com/kittu149/Chat_Application}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textit{"Explain how the Diffie Hellman key exchange algorithm works and also how the PKI setup is done."}
    \item \textit{"Explain the difference between AES and AES-GCM."}
\end{enumerate}
